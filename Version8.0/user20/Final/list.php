            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Traveling Details</h2>
                        <a href="new.php" class="btn btn-success pull-right">Add a New Country</a>
                    </div>
                    <?php
                    // Include config file
                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<p class='lead'><em>There are no future plans added.</em></p>";
                        }
                    } else{
