...
/////////////////////////EDIT THIS LINE/////////////////////////////////////////////////////
    ...
    if ($i % 3 == 0) {
      $results .= "<tr><td><img src=\"$pic\"></td><td><a href=\"$link\">$title</a></td><td>$$price</td>";
    }
    if ($i % 3 == 1) {
      $results .= "<td><img src=\"$pic\"></td><td><a href=\"$link\">$title</a></td><td>$$price</td>";
    }
    else {
      $results .= "<td><img src=\"$pic\"></td><td><a href=\"$link\">$title</a></td><td>$$price</td></tr>";
    }
    $i++;
////////////////////////EDIT THIS LINE//////////////////////////////////////////////////////      
  }
