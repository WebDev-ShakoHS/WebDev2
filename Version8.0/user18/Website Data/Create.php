...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Validate username
    if (empty(trim($_POST["pcname"]))) {
        $username_err = "Please enter a PC Name.";
    } else {
        // Prepare a select statement
        $sql = "CREATE id FROM pcdata WHERE username = ?";
...
<nav id="mySidebar" class="sidebar">
        ...
        <a href="2009-2013.html">2009-2013</a>
        <a href="2014-2017.html">2014-2017</a>
        <a href="2018-2021.html">2018-2021</a>
        <a href="http://localhost:8080/webdev2/Version8.0/user18/login.php">Login</a>
        <a>
            <p>Logged in as:</p>
        </a>
    </nav>
