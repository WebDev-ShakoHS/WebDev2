<?php
$apiKey = "948a3eb9bd67d49d7fbebd1c4cf0d738"; //You will need to add in the 
...
<body>
    ...
    <div class="background color"><?php
$x = 2001;  
if ($x >2000){
$color='blue';}
else{ 
...
var_dump($color);//returns true because $x is greater than $y
?>

        <body style="background-color:<?php echo $color ?>;"></body></div>
