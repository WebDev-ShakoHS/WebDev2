...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($input_dollar)){
        $sdollar_err = "Please enter the dollar amount.";     
    ...
    if(empty($name_err) && empty($address_err) && empty($dollar_err)){
        ...
        $sql = "UPDATE employees SET name=?, address=?, dollar=? WHERE id=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssi", $param_name, $param_address, $param_dollar, $param_id);
